...
public class RejectionAnalysis extends Driver {
    ...
    *******************************************************************************************/
    ...
    public void startOfData() {
        ...
        try {
            ...
            for (int i = 0; i < plotnum; i++) {
                root.init("TProfile","profile"+Integer.toString(i),"rej"+Integer.toString(PalletRadius+i),
                "Rejection Prad " + Integer.toString(PalletRadius+i), 70, 1, 8, 0.0, 1.0);
            }
        }
    ...
    public void process( EventHeader event ) {
        ...
        try {
            System.out.println("****"+DBtileFile);
            System.out.println("****"+DBcylFile);
            ...
            for (int pradI = 0; pradI <  LastPalletRadius - PalletRadius + 1; pradI++) {
                ...
                //perform rejection rate testing across various sigma cuts
                for (double sigma = 1; sigma <= 8; sigma += 0.1) {
                    ...
                    root.fill("profile"+Integer.toString(pradI),sigma,pur);
                }
