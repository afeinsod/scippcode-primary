...
public class SQLITEWrapper2 {
  ...
  public void addTable(String table)
      ...
      sqlstat = sqlstat.concat(" ( column1, column2, column3, column4);");
  ...
  public Double getDouble2(Object ref, String table) 
      throws java.sql.SQLException { 
      return (Double)selectResults(table,ref)[2];
  }

  //Get String related to the reference object
  public Integer getInt(Object ref, String table)
      throws java.sql.SQLException { 
      return (Integer)selectResults(table,ref)[3];
  }
  ...
  public PreparedStatement updateStatement(String table) 
      ...
      prefixStr = prefixStr.concat(table);
      prefixStr = prefixStr.concat(" set column1=?, column2=?, column3=?, column4=? where column1=?;");
      return this._conn.prepareStatement(prefixStr);
  }
